...
mxGraph.prototype.initOverrite = function () {
  ...
  if (typeof mxVertexHandler !== 'undefined') {
    ...
    this.graphHandler.createPreviewShape = function (bounds) {
      this.previewColor = (mxGraph.graph.background == '#000000') ? '#ffffff' : mxGraphHandler.prototype.previewColor;
  ...
  mxConnector.prototype.paintLine = function (c, absPts, rounded) {
    ...
    if (this.outline || this.state == null || this.style == null ||
      ...
      var size = (parseInt(mxUtils.getValue(this.style, 'jumpSize',
        mxGraph.defaultJumpSize)) - 2) / 2 + this.strokewidth;
 ...
 */
mxGraph.prototype.loadStylesheet = function () {
  debugger
