...
System.register(['app/plugins/sdk', './libs/mxgraph/js/mxClient', './libs/mxgraph/js/mxUtils', './libs/mxgraph/js/mxCodec', './properties', 'lodash', './series_overrides_flowchart_ctrl'], function (_export, _context) {
  "use strict";

  var MetricsPanelCtrl, mxClient, mxUtils, mxCodec, diagramEditor, displayEditor, shapeEditor, valueEditor, _, _createClass, mxBasePath, FlowchartCtrl;
  ...
  return {
    ...
    }, function (_libsMxgraphJsMxClient) {
      mxClient = _libsMxgraphJsMxClient.default;
    }, function (_libsMxgraphJsMxUtils) {
      mxUtils = _libsMxgraphJsMxUtils.default;
    }, function (_libsMxgraphJsMxCodec) {
      mxCodec = _libsMxgraphJsMxCodec.default;
    ...
    execute: function () {
      ...
      _export('FlowchartCtrl', FlowchartCtrl = function (_MetricsPanelCtrl) {
        ...
        function FlowchartCtrl($scope, $injector, $rootScope) {
          ...
          _this.panel = panelDefaults;
          _this.panel.legend = panelDefaults.legend;
