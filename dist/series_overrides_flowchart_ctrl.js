...
System.register([], function (_export, _context) {
  ...
  return {
    setters: [],
    execute: function () {
      angular.module('grafana.controllers').controller('SeriesOverridesFlowchartCtrl', ['$scope', '$element', 'popoverSrv', function ($scope, $element, popoverSrv) {
        $scope.overrideMenu = [];
...
//# sourceMappingURL=series_overrides_flowchart_ctrl.js.map
