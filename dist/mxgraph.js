...
exports.mxClient = exports.mxGraph = undefined;

var _mxgraphJs = require('./libs/mxgraph-js/dist/mxgraph-js');

window.mxImageBasePath = __dirname + '/libs/mxgraph/javascript/src/images';
window.mxBasePath = __dirname + '/libs/mxgraph/javascript/src';

window.mxGraph = _mxgraphJs.mxGraph;
window.mxClient = _mxgraphJs.mxClient;
//console.log(window);
exports.mxGraph = _mxgraphJs.mxGraph;
exports.mxClient = _mxgraphJs.mxClient;
...
//   window.mxRubberband = mxgraph.mxRubberband window.mxCellState = mxgraph.mxCellState
