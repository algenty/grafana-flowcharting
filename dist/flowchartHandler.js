...
var FlowchartHandler = function () {
  ...
  _createClass(FlowchartHandler, [{
    ...
    key: "asyncRefreshStates",
    value: function () {
      var _asyncRefreshStates = _asyncToGenerator(regeneratorRuntime.mark(function _callee(rules, series) {
      ...
      function asyncRefreshStates(_x, _x2) {
        return _asyncRefreshStates.apply(this, arguments);
      }

      return asyncRefreshStates;
    }()
  }, {
    key: "refresh",
