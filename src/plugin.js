...
const plugin= {
  ...
  "info": {
    ...
    "contributors": [
      "Jeremy Branham (https://www.linkedin.com/in/jeremybranham/)"
    ],
    "keywords": ["flowchart", "panel", "diagram", "mxgraph"],
    "links": [
      {"name": "Project site", "url": "https://github.com/algenty/grafana-flowcharting"},
      {"name": "Apache License", "url": "https://github.com/algenty/grafana-flowcharting/blob/master/LICENSE"}
    ],
    "version": "0.0.1",
    "updated": "2019-01-26",
    "logos": {
