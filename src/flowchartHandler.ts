...
export default class FlowchartHandler {
  ...
  constructor($scope: ng.IScope, elem: any, ctrl: any, data: gf.TFlowchartData[]) {
    ...
    console.log('TCL: FlowchartHandler -> constructor -> FlowchartHandler.defaultXml', FlowchartHandler.defaultXml);
