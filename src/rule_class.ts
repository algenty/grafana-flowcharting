...
import { TIRuleData, GFP, TShapeMapData, TTextMapData, TlinkMapData, TValueMapData, TRangeMapData, TGFMapData } from '../types';
...
export default class Rule {
   ...
   * @memberof Rule
   */
  constructor(pattern: string, data: TIRuleData) {
    this.data = data;
  ...
  static getDefaultData(): TIRuleData {
    return {
      order: 1,
      pattern: '.*',
      unit: 'short',
