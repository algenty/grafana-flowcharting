...
class MetricTooltip {
  ...
  setDirection(direction: TDirection): this {
  ...
  addGraph(type: TGraphType): GraphTooltip {
...
class GraphTooltip {
  ...
  setType(type: TGraphType): this {
    this.type = type;
    return this;
  }

  setSize(size: TGraphSize): this {
    this.size = size;
    return this;
  }
